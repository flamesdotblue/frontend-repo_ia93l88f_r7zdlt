...
const services = [
  {
    ...
    desc: "Assistance, New, Renewal, Changes",
    icon: BadgeCheck,
  },
  {
    title: "International Air Tickets",
    desc: "Worldwide flight bookings",
    icon: Plane,
  },
  {
    title: "Hotel Reservations",
    desc: "Worldwide accommodations",
    icon: Hotel,
  },
  {
    title: "Visa Submissions",
    desc: "Visa application assistance",
    icon: Globe,
  },
  {
    title: "Foreign Exchanges",
    desc: "Currency exchange services",
    icon: Wallet,
  },
  {
    title: "International Package Tours",
    desc: "Curated travel packages",
    icon: Package,
  },
  {
    title: "Online Applications",
    desc: "Applications and Changes",
    icon: Mail,
  },
  {
    title: "Travel Bookings",
    desc: "Bus, Train & Flight bookings",
    icon: Train,
  },
  {
    title: "GARUDAVEGA",
    desc: "International Couriers",
    icon: Package,
  },
  {
    title: "Courier Services",
    desc: "Domestic Courier and Parcel",
    icon: Bus,
  },
  {
    title: "Government Services",
    desc: "E-Aadhaar and PAN Card",
    icon: Building2,
  },
  {
    title: "Money Services",
    desc: "Transfer and Withdrawal",
    icon: CreditCard,
  },
  {
    title: "Bill Payments",
    desc: "FastTag Registration",
    icon: Wallet,
  },
  {
    title: "Bus Partners",
    desc: "VRL, SRS, Durgamba",
    icon: Bus,
  },
];
    ...
    <section id="services" className="relative py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <div key={s.title} className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-lg">
